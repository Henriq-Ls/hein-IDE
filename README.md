...
## ⚠️ Aviso do Windows (SmartScreen) — Leia antes de abrir
...
* **Como resolver:** Clique nos três pontinhos (`...`) ao lado do aviso ➡️ Selecione **"Manter"** ou **"Manter assim mesmo"**.

### 🛡️ Passo 2 — Ao Abrir (Windows SmartScreen)
...
* **Como resolver:** Clique no link **"Mais informações"** logo abaixo do texto ➡️ Depois clique no botão **"Executar assim mesmo"**.
...
* **💻 Terminais Integrados:** * Terminal PowerShell completo com suporte a múltiplas abas.
...
---
<p align="center">Desenvolvido com 💚 por <a href="https://github.com/Henriq-Ls">HenriqLs</a></p>
